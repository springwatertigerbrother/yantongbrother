...
- (void)initRun {
    ...
    for (int i = [condKeyArr count] - 1; i >=0; i--) {
...
- (void)dealloc
{
    ...
    [conDict release];  conDict = nil;
    [runDict release];  runDict = nil;
    
    [condKeyArr release]; condKeyArr = nil;
    
    [adRunStateMgr release]; adRunStateMgr = nil;
    
    [modeNameArr release]; modeNameArr = nil;
    [modeValueArr release]; modeValueArr = nil;
    [sizeNameArr release]; sizeNameArr = nil;
    [sizeValueArr release]; sizeValueArr = nil;
    [timeNameArr release]; timeNameArr = nil;
    [timeValueArr release]; timeValueArr = nil;
...
- (void)run {
    ...
    //start one.
    ++nAdProviderIndex;
    int count = [[self.adProviders allKeys] count];
...
- (IBAction)adConfirmAction:(id)sender
{
    ...
    switch (view1.tag) {
        case OK_BTN_TAG:
        {
            ...
            int nSel = segView.selectedSegmentIndex;
